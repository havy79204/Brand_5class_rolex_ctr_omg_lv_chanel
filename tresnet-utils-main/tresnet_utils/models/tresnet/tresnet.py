...
from tresnet_utils.models.tresnet.layers.avg_pool import FastGlobalAvgPool2d
from tresnet_utils.models.tresnet.layers.squeeze_and_excite import SEModule
