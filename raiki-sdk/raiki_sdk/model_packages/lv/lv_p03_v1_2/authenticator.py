"""
Authenticator for Louis Vuitton P03
...
from .config import (
    ...
    YOLO_MODEL_VERSION_1, YOLO_MODEL_VERSION_2, AUTH_CLASS_LABELS)
...
class LVP03Authenticator(AuthenticateBase):
    """
    Authentication model for Louis Vuitton P03
    """
    ...
    def __init__(self, device: str):
        ...
        Args:
            model: LVP03Architecture instance
        ...
        self.metadata = {
            ...
            "yolo_model_1_version": YOLO_MODEL_VERSION_1,
            "yolo_model_2_version": YOLO_MODEL_VERSION_2,
        }
    ...
    def forward(self, image) -> AuthResult:
        """
        Authenticate Louis Vuitton P03 part
        ...
        with torch.inference_mode():
            ...
            # result = self.model_auth(scource)
            # probs = torch.softmax(result, -1).squeeze(0)
            # return self.get_prob(probs)

            output1, output2, output3, output_concat, map1, map2, map3 = self.model(scource)
