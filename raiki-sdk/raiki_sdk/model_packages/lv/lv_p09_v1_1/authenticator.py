"""
Authenticator for Louis Vuitton P09 V1.1
...
class LVP09Authenticator(AuthenticateBase):
    """
    Authentication model for Louis Vuitton P09 V1.1
    """
    ...
    def forward(self, image: Image.Image) -> AuthResult:
        """
        Authenticate Louis Vuitton P09 V1.1 part
    ...
    def get_prob(self, probs: torch.Tensor) -> Tuple[float, str]:
        ...
        if index == 0 or index == 2:
            return min(0.5, 1.0 - probs[0].item()), simple_label
        return max(0.65, probs[index].item()), simple_label
