"""
Authenticator for Louis Vuitton P04 Case 4
...
from .architecture import _load_model
...
class LVP04Case4Authenticator(AuthenticateBase):
    """
    Authentication model for Louis Vuitton P04 Case 4
    """
    ...
    def __init__(self, device: str):
        ...
        Args:
            model: LVP04Case4Architecture instance
            transform: Image transformation pipeline
            device: Device to run model on (cuda/cpu)
        """
        self.device = device

        self.model = _load_model(AUTH_WEIGHTS, device)
    ...
    def forward(self, image) -> AuthResult:
        """
        Authenticate Louis Vuitton P04 Case 4 part
