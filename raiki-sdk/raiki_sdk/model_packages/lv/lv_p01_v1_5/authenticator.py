"""
Authenticator for Louis Vuitton P01
...
class LVP01Authenticator(AuthenticateBase):
    """
    Authentication model for Louis Vuitton P01
    """
    ...
    def __init__(self, device: str):
        ...
        Args:
            model: LVP01Architecture instance
    ...
    def forward(self, image) -> AuthResult:
        """
        Authenticate Louis Vuitton P01 part
