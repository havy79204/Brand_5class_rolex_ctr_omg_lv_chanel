"""
YOLO Detector for Louis Vuitton P06
...
class LVP06Detector(DetectorBase):
    """
    YOLO detector for Louis Vuitton P06 part detection
    """
    ...
    def detect(self, image) -> YoloResult:
        """
        Detect Louis Vuitton P06 parts in the image
    ...
    def validate(self, results) -> YoloValidation:
        ...
        for box in results.boxes:
            ...
            #  {0: 'convex_rivet', 1: 'fitting', 2: 'flat_rivet', 3: 'socket'}
            if cls_id in [0, 2]:
                valid = True
