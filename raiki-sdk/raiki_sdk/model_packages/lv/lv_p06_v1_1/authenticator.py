"""
Authenticator for Louis Vuitton P06
...
class LVP06Authenticator(AuthenticateBase):
    """
    Authentication model for Louis Vuitton P06
    """
    ...
    def __init__(self, device: str):
        ...
        Args:
            model: LVP06Architecture instance
    ...
    def forward(self, image) -> AuthResult:
        """
        Authenticate Louis Vuitton P06 part
