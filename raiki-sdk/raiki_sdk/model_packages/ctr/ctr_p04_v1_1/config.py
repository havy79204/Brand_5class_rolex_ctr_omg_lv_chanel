"""
Configuration for CTR P04 Models Version 1.1
"""
...
YOLO_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/ctr_p04_detector_v1-1",
    filename="ctr_p04_detector_v1-1_20260206_20260206.pt"
)
AUTH_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/ctr_p04_auth_v1-1",
    filename="ctr_p04_auth_v1-1_onestage_maxvitbase_20260212_20260212.pth"
)
