...
CLASSIFIER_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/rolex_p00_classify_v1-5",
    filename="rolex_p00_classify_v1.5_252classes_dinov3-arceface-vector-50gray_20250129_20250129.pth"
)

EMBEDDING_STORAGE_PKL = download_file_from_hf(
    repo_id="rikai-ai/rolex_p00_classify_v1-5",
    filename="rolex_p00_classify_1.5_252classes_dinov3-arceface-vector-withgray-storage_20250126_20250116_v1.pkl"
)

# Classifier model parameters
TARGET_SIZE = 256
CLASSIFIER_MODEL_NAME = "vit_base_patch16_dinov3.lvd1689m"
CLASSIFIER_NUM_CLASSES = 252
