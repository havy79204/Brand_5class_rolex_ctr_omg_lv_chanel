...
AUTH_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/rolex_p05_auth_v1-3",
    filename="rolex_p05_auth_v1-3_maxvittiny-512_250710_250711.pth"
)
...
AUTH_NUM_CLASSES = 4
AUTH_CLASS_LABELS = ['fake', 'real_a', 'real_c', "superfake"]
