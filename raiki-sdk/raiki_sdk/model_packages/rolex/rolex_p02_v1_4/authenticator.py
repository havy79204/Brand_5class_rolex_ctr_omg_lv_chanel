...
class RolexP02Authenticator(AuthenticateBase):
    """
    Authentication model for Rolex P02
    """
    ...
    def __init__(self, device: str):
        ...
        Args:
            model: RolexP02Architecture instance
