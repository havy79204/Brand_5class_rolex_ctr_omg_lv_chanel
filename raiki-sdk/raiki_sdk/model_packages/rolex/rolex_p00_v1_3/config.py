...
CLASSIFIER_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/rolex_p00_classify_v1-3",
    filename="rolex_p00_classify_v1.3_dinov3-arceface-vector-50gray_20251203_20251204.pth"
)

EMBEDDING_STORAGE_PKL = download_file_from_hf(
    repo_id="rikai-ai/rolex_p00_classify_v1-3",
    filename="rolex_p00_classify_1.3_dinov3-arceface-vector-withgray-storage_20251223_20251204_v3.pkl"
)

# Classifier model parameters
TARGET_SIZE = 256
CLASSIFIER_MODEL_NAME = "vit_base_patch16_dinov3.lvd1689m"
CLASSIFIER_NUM_CLASSES = 212
