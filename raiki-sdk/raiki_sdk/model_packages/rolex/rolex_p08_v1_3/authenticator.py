...
from .architecture import ReducedNetworkCaformer
...
class RolexP08Authenticator(AuthenticateBase):
    ...
    def __init__(self, device: str):
        ...
        """
        self.device = device
        self.model = ReducedNetworkCaformer(num_classes=AUTH_NUM_CLASSES,checkpoint=AUTH_WEIGHTS, device=device).to(self.device).eval()
