...
AUTH_WEIGHTS_1 = download_file_from_hf(
    repo_id="rikai-ai/rolex_p04_auth_maxvit_v1.4",
    filename="rolex_p04_auth_maxvit_512_v1_4.pth"
)
...
# AUTH parameters
TARGET_SIZE = 512
AUTH_MODEL_1_NAME = "maxvit_small_tf_512.in1k"
