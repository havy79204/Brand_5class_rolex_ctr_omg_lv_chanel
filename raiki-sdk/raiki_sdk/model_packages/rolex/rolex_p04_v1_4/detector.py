...
class RolexP04Detector(DetectorBase):
    ...
    def validate(self, results: YoloResult) -> YoloValidation:
        ...
        if best_result:
            ...
            # Apply 30% margin to left and right from original position
            width = x2 - x1
            horizontal_padding = int(width * 0.3)
            
            x1_p = x1 - horizontal_padding
            x2_p = x2 + horizontal_padding
            position = [x1_p, y1, x2_p, y2]
