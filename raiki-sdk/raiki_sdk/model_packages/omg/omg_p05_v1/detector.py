...
class OMGP05Detector(DetectorBase):
    ...
    def validate(self, results: YoloResult) -> YoloValidation:
        ...
        # Lưu class_id vào instance variable
    ...
    def crop(self, image, position, class_id=None) -> Image.Image:
        ...
        """
        if self.img_preparing_yolo is None:
            raise ValueError("self.img_preparing_yolo is None. Call detect() before crop()")
        
        # Nếu class_id không được truyền, dùng class_id từ validate()
        if class_id is None:
        ...
        # Rotate to normalize orientation (if class_id provided)
