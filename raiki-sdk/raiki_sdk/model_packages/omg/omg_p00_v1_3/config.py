...
CLASSIFIER_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/om_p00_classify_v1-3",
    filename="om_p00_classify_v1.3_dinov3-arcface_101classes_20260222_20260222.pth"
)

EMBEDDING_STORAGE_PKL = download_file_from_hf(
    repo_id="rikai-ai/om_p00_classify_v1-3",
    filename="om_p00_classify_v1.3_dinov3-arcface_vector-storage_20260222_20260222.pkl"
)

# Classifier model parameters
TARGET_SIZE = 256
CLASSIFIER_MODEL_NAME = "vit_base_patch16_dinov3.lvd1689m"
CLASSIFIER_NUM_CLASSES = 101
