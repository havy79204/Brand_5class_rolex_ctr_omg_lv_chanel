"""
Configuration for Omega P05 Models Version 1.1
"""
...
YOLO_MODEL_VERSION = "v1-2"

# Model weights paths (relative to package root or absolute)
YOLO_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/omg_p05_detector_v1-2",
    filename="omg_p05_detector_v1-2_20251229_20251209.pt"
)
AUTH_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/omg_p05_auth_v1-1",
    filename="omg_p05_auth_v1.1_convnextv2_384_20260115_20260115.pth" 
)
