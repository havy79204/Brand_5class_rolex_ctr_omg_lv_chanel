...
AUTH_WEIGHTS = download_file_from_hf(
    ...
    filename="lv_p04_auth_v1-3_pmal_250926_251107.pth"
)

DECODER1_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/lv_p04_auth_v1-3",
    filename="lv_p04_auth_v1-3_pmal-decoder1_250926_251107.pth"
)

DECODER2_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/lv_p04_auth_v1-3",
    filename="lv_p04_auth_v1-3_pmal-decoder2_250926_251107.pth"
)

DECODER3_WEIGHTS = download_file_from_hf(
    repo_id="rikai-ai/lv_p04_auth_v1-3",
    filename="lv_p04_auth_v1-3_pmal-decoder3_250926_251107.pth"
)

# AUTH parameters
TARGET_SIZE = 421
AUTH_MODEL_NAME = "PMAL"
AUTH_NUM_CLASSES = 4
